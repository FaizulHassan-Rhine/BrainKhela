...
/** Unique key for deduping — prefer stable id so GK variants like "…? [5]" are kept. */
...
export const GK_CATEGORY_COLORS = {
  Bangladesh: 'from-secondary to-accent',
  International: 'from-accent to-cream-light',
  ...
  Literature: 'from-cream-dark to-secondary',
  'General Knowledge': 'from-primary to-secondary',
